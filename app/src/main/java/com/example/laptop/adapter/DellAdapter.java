...
public class DellAdapter extends RecyclerView.Adapter<DellAdapter.MyViewHolder> {
    Context context;
    List<Product> listDell;

    public DellAdapter(Context context, List<Product> listDell) {
        this.context = context;
        this.listDell = listDell;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Product product = listDell.get(position);
