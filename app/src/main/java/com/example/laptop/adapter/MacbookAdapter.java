...
public class MacbookAdapter extends RecyclerView.Adapter<MacbookAdapter.MyViewHolder> {
    Context context;
    List<Product> listMac;

    public MacbookAdapter(Context context, List<Product> listMac) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MacbookAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Product product = listMac.get(position);
